...
$table->setText(5,0,'Font');
$table->setText(5,1,display_font($font_family, $font_size));
...
if(!empty($text2display)){
	...
	$table->setText(8,0,'<img src="image.php?code='.$filename.'&amp;o='.$output.'&amp;t='.$thickness.'&amp;r='.$res.'&amp;text='.urlencode($text2display).'&amp;f1='.$font_family.'&amp;f2='.$font_size.'&amp;a1='.$a1.'&amp;a2='.$a2.'&amp;a3='.$a3.'" alt="Barcode Image" />');
} 
?>
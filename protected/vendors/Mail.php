...
class Mail{
	...
	protected function _prep_q_encoding($str, $from = FALSE)
	{
		...
		$limit = 750 - 7 - strlen($this->charset);
	...
	{
		if (substr($msg, 0, 5) != 'lang:' || FALSE === ($line = $this->_get_error_template(substr($msg, 5))))
		{
	 ...
	 * @return	array
	 */
	protected function _get_error_template($line)
	{
		$default = array(
		...
		return isset($default[$line]) ? $default[$line] : '';
	}

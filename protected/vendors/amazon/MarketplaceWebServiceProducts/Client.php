...
class MarketplaceWebServiceProducts_Client implements MarketplaceWebServiceProducts_Interface
{
    ...
    public function getLowestPricedOffersForASIN($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForASINRequest)) {
            require_once ('MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForASINRequest.php');
        ...
        require_once ('MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForASINResponse.php');
    ...
    public function getLowestPricedOffersForSKU($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForSKURequest)) {
            require_once ('MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForSKURequest.php');
        ...
        require_once ('MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForSKUResponse.php');
    ...
    public function getMyFeesEstimate($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetMyFeesEstimateRequest)) {
            require_once ('MarketplaceWebServiceProducts/Model/GetMyFeesEstimateRequest.php');
        ...
        require_once ('MarketplaceWebServiceProducts/Model/GetMyFeesEstimateResponse.php');
   ...
   private function collapseWhitespace($s) {
    ...
    private function _httpPost(array $parameters)
    {
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);//change false by ellan ,not self-cerfication

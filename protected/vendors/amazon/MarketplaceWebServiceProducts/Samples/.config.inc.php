<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAJC64PSCPRD72BOFA');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'yibai_api');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A3UOH6UFKYX3BS');

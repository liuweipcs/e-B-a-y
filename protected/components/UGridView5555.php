...
// 		echo '</div>';
	...
	public function renderMouserRight(){    
		...
		$div='<div id="mouse_right_menu" style="width:120px;display:none;position:absolute;z-index:999;"><ul style="background-color: #fff;border: 1px solid #999;list-style: none outside none;width: 130px;">';
		...
		if (is_string($this->toolBar)){
            ...
            foreach ($this->toolBar as $item){ 
            	...
            	$div.="<li style='font-size:13px;background-color: transparent;border: 1px solid #fff;color: #000;display: block; margin: 0;padding:3px;text-align: left;'>".CHtml::link($item['text'],$item['url'],$item['htmlOptions'])."</li>";           	
            }
       	}
...
//        	}      
       	...
       	$div .= "<li style='font-size:13px;background-color: transparent;border: 1px solid #fff;color: #000;display: block; margin: 0;padding:3px;text-align: left;'><a href='javascript:copy();'>" . Yii::t('system', 'Copy') . "</a></li></ul></div>";
...
// 	                		}
    ...
    public function renderOrderBar() {
    	echo '<li class="orderBar" style="float:right;padding-right:0px;" >';

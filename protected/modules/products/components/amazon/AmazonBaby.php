 ...
 */
class AmazonBaby extends AmazonUpload implements IAmazonUpload
{
	/**
	 * @inheritdoc
	 * @noreturn
	...
	protected function createProduct()
	{
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$array['ColorMap'] = isset($variations['Color']) ? $variations['Color'] : '';
				$array['ColorName'] = isset($variations['Color']) ? $variations['Color'] : '';
				$array['SizeMap'] = 'One Size';
				$array['SizeName'] = isset($variations['Size']) ? $variations['Size'] : '';
				$array = $this->removeEmptyItemByKey($array);

 ...
 */
Class AmazonPetSupplies extends AmazonUpload implements IAmazonUpload
{
    /**
     * @inheridoc
     *
    ...
    protected function removeEmptyItem2(array $data)
    {
        ...
        foreach ($data['ProductData']['PetSupplies']['ProductType']['PetSuppliesMisc'] as $key => $value) {
            if ($this->isEmpty($value)) {
                unset($data['ProductData']['PetSupplies']['ProductType']['PetSuppliesMisc'][$key]);
            }
        }
    ...
    protected function createProduct()
    {
        ...
        //多属性
            ...
            foreach ($this->product->sonskues as $sonprd) {
                ...
                $xmls[$sonprd->sku] = $this->arr2xml->buildXML($this->removeEmptyItem2($child), 'Product');
            }
        }

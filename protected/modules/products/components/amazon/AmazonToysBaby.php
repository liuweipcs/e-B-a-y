 ...
 */
Class AmazonToysBaby extends AmazonUpload implements IAmazonUpload
{
    /**
     * @inheridoc
     *
    ...
    protected function createProduct()
    {
        ...
        //多属性
            ...
            foreach ($this->product->sonskues as $sonprd) {
                ...
                $child['ProductData'] = array(
                    'ToysBaby' => array(
                        ...
                        'VariationData' => array(
                            ...
                            'VariationTheme' => $this->product->variation_theme, //指定与父体相同的Theme
                        ),
                        'Size'=>$size,
                        'Color'=>$color,
                    ),
                ...
                $xmls[$sonprd->sku] = $this->arr2xml->buildXML($this->removeEmptyItem2($child,'ToysBaby'), 'Product');
            }
        }

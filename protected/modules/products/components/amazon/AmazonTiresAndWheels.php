 ...
 */
class AmazonTiresAndWheels extends AmazonUpload implements IAmazonUpload
{
	/**
	 * @inheritdoc
	 * @noreturn
	...
	protected function categoryMethod($subcate) {
		$arr1 = array('Tires');
		$arr2 = array('Wheels','TireAndWheelAssemblies');
	...
	protected function createProduct()
	{
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$array['ColorSpecification'] = isset($variations['Color']) ? $variations['Color'] : $sonprd->seller_sku;
	...
	/**
	 * ('Wheels','TireAndWheelAssemblies')分类组装数据
	 * 
	 * @throws Exception
	 */

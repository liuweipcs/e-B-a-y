 ...
 */
Class AmazonThreeDPrinting extends AmazonUpload implements IAmazonUpload
{
    /**
     * @inheridoc
     *
	...
	protected function createProduct()
	{
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$xmls[$sonprd->sku] = $this->arr2xml->buildXML($this->trimTier($child,'ThreeDPrinting'), 'Product');
			}
		}

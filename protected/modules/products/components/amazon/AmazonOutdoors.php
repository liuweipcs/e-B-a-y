 ...
 */
Class AmazonOutdoors extends AmazonUpload implements IAmazonUpload
{
    /**
     * @inheridoc
     *
    ...
    protected function createProduct()
    {
        ...
        if ($this->product->product_is_multi == 0) {
            ...
            $data['ProductData'] = array(
                'Outdoors' => array(
                    'ProductType' =>array(
                        'OutdoorRecreationProduct'=>array(
                            'Seasons'=>'Seasons'
                        )
                    ),
                ),
                ...
                $child['ProductData'] = array(
                    'Outdoors'=>array(
                        ...
                        'VariationData' => array(
                            ...
                            'VariationTheme' => $this->mapThemeVaris($this->product->variation_theme), //指定与父体相同的Theme
                        ),
                    ),
                );

                $xmls[$sonprd->sku] = $this->arr2xml->buildXML($this->removeEmptyItem2($child,'Outdoors','OutdoorRecreationProduct'), 'Product');
            }
        }

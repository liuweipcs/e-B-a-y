 ...
 */
class AmazonLuxuryBeauty extends AmazonUpload implements IAmazonUpload
{
	/**
	 * @inheritdoc
	 * @noreturn
	...
	protected function createProduct()
	{
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$array['ColorSpecification']['Color'] = isset($variations['Color']) ? $variations['Color'] : $sonprd->seller_sku;
	...
	{       //单品
        if ($type == 0) {
            return array(
                    'ProductType' => 'LuxuryBeauty',
                    'UnitCount' => array(
									'@unitOfMeasure' => unserialize($this->product->productdata->product_data)['unitOfMeasure'],
									'%' => unserialize($this->product->productdata->product_data)['UnitCount'],
									),

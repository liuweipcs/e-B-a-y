 ...
 */
class AmazonEntertainmentCollectibles extends AmazonUpload implements IAmazonUpload
{
	...
	{
		$arr = array('EntertainmentMemorabilia',
					);
	...
	*/
	protected function SolidUpload($cate, $subcate, $data) 
	{
		...
		$data['DescriptionData']['Autographed'] = unserialize($this->product->productdata->product_data)['IsAutographed'];
	...
	protected function _EntertainmentMemorabilia()
	{
            return array(
	            	"Actor" => '',
					"Artist" => '',
					"AuthenticatedBy" => unserialize($this->product->productdata->product_data)['AuthenticatedBy'],
					"AuthenticityNumber" => '',
					"Band" => '',
					"CollectibleType" => unserialize($this->product->productdata->product_data)['CollectibleType'],
					"Composer" => '',
					"ConditionProvidedBy" => unserialize($this->product->productdata->product_data)['ConditionProvidedBy'],
					"Conductor" => '',
					"CountryOfOrigin" => '',
					"DateOfPerformance" => '',
					"DisplayDepth" => '',
					...
					"DisplayWeight" => '',
					"DisplayWidth" => '',
					"EntertainmentBrand" => unserialize($this->product->productdata->product_data)['EntertainmentBrand'],
					"EntertainmentType" => unserialize($this->product->productdata->product_data)['EntertainmentType'],
					"EventName" => '',
					"Genre" => unserialize($this->product->productdata->product_data)['Genre'],
					"IsAdultProduct" => unserialize($this->product->productdata->product_data)['IsAdultProduct'],
					"IsPerformanceUsed" => unserialize($this->product->productdata->product_data)['IsPerformanceUsed'],
					"GradeRating" => unserialize($this->product->productdata->product_data)['GradeRating'],
					"ItemThicknessString" => '',
					...
					"IsVeryHighValue" => '',
					"Contributor" => '',
					"AdditionalProductInformation" => unserialize($this->product->productdata->product_data)['AdditionalProductInformation'],
	            	);
	}

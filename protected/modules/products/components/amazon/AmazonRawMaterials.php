 ...
 */
class AmazonRawMaterials extends AmazonUpload implements IAmazonUpload
{
	/**
	 * @inheritdoc
	 * @noreturn
	...
	protected function categoryMethod($subcate) {
		$arr1 = array('CeramicBalls','CeramicTubing','Ceramics','MetalBalls',
			'MetalMesh','MetalTubing','Metals','PlasticBalls',
			'PlasticMesh','PlasticTubing','Plastics','RawMaterials','Wire');
	...
	protected function createProduct()
	{
		...
		if ($type == 0) {
			...
			$data['ProductData'][$cate]['ProductType'] = $subcate;
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$child['ProductData'][$cate]['ProductType'] = $subcate;

 ...
 */
class AmazonLighting extends AmazonUpload implements IAmazonUpload
{
	/**
	 * @inheritdoc
	 * @noreturn
	...
	protected function categoryMethod($subcate) {
		$arr1 = array('LightsAndFixtures');
		$arr2 = array('LightingAccessories');
		$arr3 = array('LightBulbs');
	...
	protected function createProduct()
	{
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$key = $subcate == 'LightsAndFixtures' ? 'Color' : 'Wattage';
				$array[$key] = isset($variations['Color']) ? $variations['Color'] : $sonprd->seller_sku;

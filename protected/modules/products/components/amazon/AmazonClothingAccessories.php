 ...
 */
class AmazonClothingAccessories extends AmazonUpload implements IAmazonUpload
{
	/**
	 * @inheritdoc
	 * @noreturn
	...
	{
		$arr1 = array('ClothingAccessories');
	...
	protected function createProduct()
	{
		...
		//多属性
			...
			foreach ($this->product->sonskues as $sonprd) {
				...
				$array['VariationData']['Color'] = isset($variations['Color']) ? $variations['Color'] : '';
				$array['VariationData']['Size'] = isset($variations['Size']) ? $variations['Size'] : '';
        ...
        if ($type == 0) {
            return array(
                    'ClassificationData' => array(
                    	'Department' => unserialize($this->product->productdata->product_data)['Department'],
                    	),
	            	);
        }
       	//多属性 

 ...
 */
class AmazonMusic extends AmazonUpload implements IAmazonUpload
{
	...
	*/
	...
	protected function _MusicPopular()
	{
		//$VRD = unserialize($this->product->productdata->product_data)['VinylRecordDetailsType'];
            return array(
					"MediaType" => 'audioCD',
					"VinylRecordDetails" => 'unknown',
	            	);
	}

	protected function _MusicClassical()
	{
		//$VRD = unserialize($this->product->productdata->product_data)['VinylRecordDetailsType'];
            return array(
					"MediaType" => 'audioCD',

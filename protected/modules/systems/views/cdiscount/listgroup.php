...
$this->widget('UGridView', array(
	...
	'toolBar' => array(
		array(
			...
			'url'           => '/systems/cdiscount/groupcreate',
			'htmlOptions'   => array(
				'class'     => 'add',
				'target'    => 'dialog',
				'rel'       => 'press-grid',
        ...
        array(
    		...
    		'buttons' => array(
				'groupupdate' => array(
					...
					'url' => 'Yii::app()->createUrl("/systems/cdiscount/groupupdate", array("id" => $data->id))',
					'title' => '编辑',
					'options' => array('target' => 'dialog','width'=>500,'height'=>200,'class'=>'btnEdit'),
				),
				'delete' => array(
					'url'       => 'Yii::app()->createUrl("/systems/cdiscount/groupdelete", array("id" => $data->id))',
					'label'     => '删除',
					'options'   => array(
						'target'    => 'dialog',
						'class'     => 'btnDel',

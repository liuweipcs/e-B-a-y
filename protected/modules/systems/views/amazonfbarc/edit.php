...
<div class="pageContent">
    ...
    ?>
    <?php echo CHtml::hiddenField('pdata[id]', $model->id) ?>
        ...
        <div>
            <div class="row">
                ...
                <div id="item-fabrc">
                    <fieldset style="margin: 5px 10px;">
                        <?php echo CHtml::checkBoxList('pdata[weeks]',explode(',',$model->weeks),
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <?php echo CHtml::dropDownList('pdata[group_id]',
                    ...
                    array('class'=>'required fbarc-select','style'=>'height:100px','disabled'=>true)
                );?>
            </div>
            <!--<div class="row" style="margin-top: 10px;">
                <label style="width: 60px">状态:</label>
                <?php /*echo CHtml::dropDownList('pdata[state]', $model->state, array(
                    '1' => '启用',
                    '2' => '禁用',
                )) */?>
            </div>-->

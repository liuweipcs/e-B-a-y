...
$this->widget('UGridView', array(
		...
		'columns' => array(
				...
				array(
						'name'=>'国家',
						'value'=>'UebModel::model("LazadaAccount")->getCountryName($data->country_code)',
						'htmlOptions'=>array(
								'style'=>'width:200px'
						)
				),
				array(
						'name'=>'店铺商品种类',
						'value'=>'UebModel::model("ProductCategory")->getCategoryCnNames($data->category_ids,"|")',
						'htmlOptions'=>array(
								'style'=>'width:300px'
						)
				),
            array(
                'name'=> 'group_id',
                'value'=> 'UebModel::model("LazadaStoreGroup")->getQueryOne($data->group_id)',
                'htmlOptions' => array('style' => 'width:100px'),
            ),
				array(
						'name'=>'绑定账号',
				...
				array(
						...
						'buttons' => array(
								'changCode' => array(
										...
										'url' => 'Yii::app()->createUrl("/systems/lazada/update", array("id" => $data->id))',

...
<div class="pageContent">
    ...
    $form = $this->beginWidget('ActiveForm',array(
        ...
        'action'      => Yii::app()->createUrl('/systems/itmodule/edit', ['id' => $model->id]),
        'htmlOptions' => array(
            'method'  => 'post',
    ...
    <div class="pageFormContent" layoutH="58">
        ...
        <div class="row xclearfix">
            ...
            <?php echo CHtml::textField('module_name', $model->module_name, array('class' => '', 'id' => 'module_name', 'style' => 'width:80%;')) ?>
        </div>
        ...
        <div class="tabs collapse" currentIndex="0" eventType="click">
            ...
            <div class="tabsContent">
                <div>
                    <?php echo CHtml::textArea('source_code', $model->source_code, array('class' => '', 'id' => 'sourcecode', 'style' => 'width:100%;height:350px;resize:none;')) ?>
                </div>
                ...
                <div>
                    <?php echo CHtml::textArea('description', $model->description, array('class'=>'', 'id' => 'codedescription', 'style' => 'width:100%;height:350px;resize:none;')) ?>
                </div>
            </div>
            ...
            <li>
                <div class="buttonActive">
                    <div class="buttonContent">
                        <button type="button" onclick="submitforme()"><?php echo Yii::t('system', 'Save') ?></button>
                    </div>
                </div>
            </li>
            <li>
...
function submitforme() {
    ...
    if (mn) {
        $('#itmodule-edit').ajaxSubmit({success : function(dta) {
            try {

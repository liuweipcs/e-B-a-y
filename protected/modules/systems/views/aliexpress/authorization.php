...
<script>
	function getAccessToken()
	{
		...
		var url 		 = 'http://authhz.alibaba.com/auth/authorize.htm';

		var url1 = url + "?" + "client_id=" + app_key + "&redirect_uri=" + redirect_uri + "&site=" + site +"&_aop_signature=" + signature;
	...
	function getreAccessToken()
	{
		...
		if (refresh == '')
		{
			...
			$.post("/systems/aliexpress/getreaccesstoken",{ 'refresh': refresh, 'id' :id}, function(data) {
			 data = eval("("+data+")");

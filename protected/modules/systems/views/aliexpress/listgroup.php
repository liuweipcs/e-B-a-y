...
$this->widget('UGridView', array(
	...
	'toolBar' => array(
		array(
			...
			'url'           => '/systems/aliexpress/groupcreate',
			'htmlOptions'   => array(
				'class'     => 'add',
				'target'    => 'dialog',
				'rel'       => 'press-grid',
        ...
        array(
    		...
    		'buttons' => array(
				'groupupdate' => array(
					...
					'url' => 'Yii::app()->createUrl("/systems/aliexpress/groupupdate", array("id" => $data->id))',
					'title' => '编辑',
					'options' => array('target' => 'dialog','width'=>1200,'height'=>600,'class'=>'btnEdit'),
				),
				'delete' => array(
					'url'       => 'Yii::app()->createUrl("/systems/aliexpress/groupdelete", array("id" => $data->id))',
					'label'     => '删除',
					'options'   => array(
						'target'    => 'dialog',
						'class'     => 'btnDel',

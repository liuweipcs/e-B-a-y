...
<script >
//    $(function(){
//        $("#LogisticsPrice_ship_code,#LogisticsPrice_m_id").chosen();
//        $(".chosen-container-single").css('width','226px');
//        $(".chosen-container .chosen-results").css('max_height','160px');
//
//        $("#LogisticsPrice_ship_code").change(function(event) {
//            var value=$(this).find("option:selected").text();
//            $("#LogisticsPrice_ship_name").val(value);
//        });
//        $("#LogisticsPrice_ship_code").change();
//
//

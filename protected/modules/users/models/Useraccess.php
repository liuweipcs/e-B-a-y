...
class Useraccess extends UsersModel
{
    ...
    */
	...
	public function getUserNameAndFullNameById($id,$type=''){
	    if($type=='uname'){
            ...
            $user = $this->getUserNameById($id);
            return array($id => $user['user_name'].'('.$user['user_full_name'].')');
        }
	}
     ...
     * @return string
     */
	public static function getUserNameAndDepartmentById($uid){
        $user=User::model()->findByPk($uid);
        $department = UebModel::model("Department")->getDepartment($user->department_id);
        return $user->user_full_name.'('.$department.')';
    }
